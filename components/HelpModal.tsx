    ...
    sections: [
      {
        ...
        content: (
          <div className="space-y-3">
            <P>Type what you ate in plain language and tap Send. The AI parses the description and returns estimated macros. You can edit any value before saving.</P>
            <P>Common foods are matched against a bundled Australian Food Composition Database (AFCD) dataset of 1,588 foods — these lookups happen locally without a network call. Packaged or branded products not in the AFCD are looked up via the Open Food Facts API.</P>
